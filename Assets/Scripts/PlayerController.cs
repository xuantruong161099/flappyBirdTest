...
public class PlayerController : MonoBehaviour {
	...
	void Start () {
		...
		GetComponent<SpriteRenderer>().material.SetFloat("_GrayscaleAmount", 0);
		GetComponent<Animator>().runtimeAnimatorController = playerAnim[Random.Range(0, playerAnim.Length)];
	}
